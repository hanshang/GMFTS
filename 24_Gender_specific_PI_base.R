...
# 
# gender_state_fh_PI_mfts_4 = foreach(ik = 13:15, .packages = c("demography", "ftsa")) %dopar% PI_fh_gender(comb_female = state_demog_female_smooth, comb_male = state_demog_male_smooth, comb_female_raw = state_demog_female_raw, comb_male_raw = state_demog_male_raw, pcamethod = "dynamic", fh = ik, nboot = 1000)
# save(gender_state_fh_PI_mfts_4, file = "gender_state_fh_PI_mfts_4.RData")
# rm(gender_state_fh_PI_mfts_4)
