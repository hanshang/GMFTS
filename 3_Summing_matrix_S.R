...
{
    level_0 = level_1_a = level_1_b = matrix(,2*no_prefecture,(16-kj))
    ...
    level_2_a_6 = level_2_a_7 = level_2_a_8 = matrix(,2*no_prefecture,(16-kj))
    ...
    level_2_b_7 = level_2_b_8 = matrix(,(2*no_prefecture),(16-kj))
    ...
    level_2_c_7 = level_2_c_8 = matrix(,(2*no_prefecture),(16-kj))
    ...
    S_mat = array(, dim = c(168, (2*no_prefecture), (16-kj)))
    for(ik in 1:(16-kj))
    {
