...
optim_interval_score_Japan_total_dynamic = optim_interval_score_Japan_female_dynamic = optim_interval_score_Japan_male_dynamic = vector(,15)
for(ik in 1:15)
{
    # Level 0
...
optim_interval_score_R5_total_dynamic = optim_interval_score_R6_total_dynamic = optim_interval_score_R7_total_dynamic = optim_interval_score_R8_total_dynamic = vector(,15)
for(ik in 1:15)
{
    # Level 2
    
    optim_interval_score_R1_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R1, series = "total",
                                                                fh = ik, index = 4)
    
    optim_interval_score_R2_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R2, series = "total",
                                                                fh = ik, index = 5)
    
    optim_interval_score_R3_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R3, series = "total",
                                                                fh = ik, index = 6)
    
    optim_interval_score_R4_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R4, series = "total",
                                                                fh = ik, index = 7)
    
    optim_interval_score_R5_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R5, series = "total",
                                                                fh = ik, index = 8)
    
    optim_interval_score_R6_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R6, series = "total",
                                                                fh = ik, index = 9)
    
    optim_interval_score_R7_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R7, series = "total",
                                                                fh = ik, index = 10)
    
    optim_interval_score_R8_total_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R8, series = "total",
                                                                fh = ik, index = 11)
    print(ik)
}
...
optim_interval_score_R5_male_dynamic = optim_interval_score_R6_male_dynamic = optim_interval_score_R7_male_dynamic = optim_interval_score_R8_male_dynamic = vector(,15)

for(ik in 1:15)
{
    # Level 3 (female)
    
    optim_interval_score_R1_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R1, series = "female",
                                                                 fh = ik, index = 12)
    
    optim_interval_score_R2_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R2, series = "female",
                                                                 fh = ik, index = 13)
    
    optim_interval_score_R3_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R3, series = "female",
                                                                 fh = ik, index = 14)
    
    optim_interval_score_R4_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R4, series = "female",
                                                                 fh = ik, index = 15)
    
    optim_interval_score_R5_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R5, series = "female",
                                                                 fh = ik, index = 16)
    
    optim_interval_score_R6_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R6, series = "female",
                                                                 fh = ik, index = 17)
    
    optim_interval_score_R7_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R7, series = "female",
                                                                 fh = ik, index = 18)
    
    optim_interval_score_R8_female_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R8, series = "female",
                                                                 fh = ik, index = 19)
    
    # Level 3 (male)
    
    optim_interval_score_R1_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R1, series = "male",
                                                               fh = ik, index = 20)
    
    optim_interval_score_R2_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R2, series = "male",
                                                               fh = ik, index = 21)
    
    optim_interval_score_R3_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R3, series = "male",
                                                               fh = ik, index = 22)
    
    optim_interval_score_R4_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R4, series = "male",
                                                               fh = ik, index = 23)
    
    optim_interval_score_R5_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R5, series = "male",
                                                               fh = ik, index = 24)
    
    optim_interval_score_R6_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R6, series = "male",
                                                               fh = ik, index = 25)
    
    optim_interval_score_R7_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R7, series = "male",
                                                               fh = ik, index = 26)
    
    optim_interval_score_R8_male_dynamic[ik] = interval_score_BU_optim(PI_val = OLS_hier_comb_dynamic, data_series = ind_R8, series = "male",
                                                               fh = ik, index = 27)
    print(ik)
}
...
optim_interval_score_P45_total_dynamic = optim_interval_score_P46_total_dynamic = optim_interval_score_P47_total_dynamic = vector(,15)
...
optim_interval_score_P45_female_dynamic = optim_interval_score_P46_female_dynamic = optim_interval_score_P47_female_dynamic = vector(,15)
...
optim_interval_score_P45_male_dynamic = optim_interval_score_P46_male_dynamic = optim_interval_score_P47_male_dynamic = vector(,15)
